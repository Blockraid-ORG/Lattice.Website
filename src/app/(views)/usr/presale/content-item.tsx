...
export default function ContentItem({ data }: { data: TResponsePresale }) {
      ...
      <Link href={`/${data.id}`}>
        ...
        <div className='px-4'>
          ...
          <div className="flex items-center justify-between text-sm mt-3">
            ...
            <div className='flex-1 text-end font-semibold'>{NumberComma(Number(data.project.totalSupply))}</div>
          </div>
          <div className='mt-3'>
