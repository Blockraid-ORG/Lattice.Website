                ...
                <div className="grid lg:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    <div className="flex">
                      ...
                      <div className='w-3 shrink-0'>:</div>
                      <div className="flex-1 text-sm break-all">{data.user.fullname}</div>
                    </div>
                    <div className="flex">
                      <div className="w-32">Wallet Address</div>
                      <div className='w-3 shrink-0'>:</div>
                      <div className="flex-1 text-sm break-all">{data.user.walletAddress ?? "-"}</div>
                    </div>
                    <div className="flex">
                      <div className="w-32">Status</div>
                      <div className='w-3 shrink-0'>:</div>
                      <div className="flex-1 text-sm">{data.user.verifications.shift()?.status ?? 'Not Verified'}</div>
                    </div>
                  </div>
                </div>
                <div className="my-2 pt-4">
                  <RowItem labelWidth="w-1/3" label="Total Supply" value={NumberComma(+data.totalSupply)} />
                  <RowItem labelWidth="w-1/3" label="Status" value={<BadgeProjectStatus status={data.status} />} />
