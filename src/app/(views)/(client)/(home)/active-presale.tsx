                    ...
                    <div>
                      ...
                      <div  className='px-3 pb-3 pt-6'>
                        <div className='space-y-2'>
                          <div className='text-xs font-semibold uppercase'>{item.project?.projectType?.name}</div>
                        ...
                        <div className='mt-4 space-y-1'>
                          ...
                          <div className='flex justify-between text-sm font-semibold'>
                            <div>Start:</div>
                            <div>{dayjs(item.startDate).format('YYYY-MM-DD HH:mm')}</div>
                          </div>
                          <div className='flex justify-between text-sm font-semibold'>
                            <div>End:</div>
                            <div>{dayjs(item.endDate).format('YYYY-MM-DD HH:mm')}</div>
                          </div>
                        </div>
                      </div>
                    </div>
