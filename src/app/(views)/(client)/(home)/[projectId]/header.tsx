  ...
  return (
    <header className="pt-[120px] pb-24 md:pb-12 w-full aspect-auto md:aspect-[12/6] lg:aspect-[1200/300] relative">
      <div className="absolute left-0 top-0 right-0 bottom-0 z-0">
        <Image
          className="h-full object-cover w-full dark:hidden opacity-50"
          alt="rocket"
          src={"/ills/ill-2-light.png"}
          width={1200}
          height={275}
        />
        <Image
          className="h-full object-cover w-full hidden dark:block opacity-50"
          alt="rocket"
          src={"/ills/ill-2.png"}
          width={1200}
          height={275}
                    ...
                    <div key={index} className="flex gap-2 items-center">
                      <div className="h-5 w-5 rounded-full overflow-hidden">
                        <Image
                          ...
                          height={80}
                          alt="name"
                          src={toUrlAsset(item.chain.logo)}
                        />
                      </div>
                      <p>{item.chain.name}</p>
                    </div>
