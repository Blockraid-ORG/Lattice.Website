    ...
    <html lang="en" suppressHydrationWarning>
      <body className={`${openSans.className} antialiased`}>
        ...
        >
          ...
          <Toaster expand={true} closeButton gap={4} richColors />
        </ThemeProvider>
      </body>
    </html>
  );
